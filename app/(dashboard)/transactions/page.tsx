...
// FIX: Type matches UploadButton props
...
const TransationsPageContent = () => {
  ...
  // FIX: Cast to match ImportCard expected type
  ...
  return (
    <div>
      ...
      <ImportCard
        ...
        onCancel={onCancelImoport}
        onSubmit={onSubmitImport as unknown as (data: unknown[]) => void} 
      />
    </div>
  );
}
  ...
  return (
    <div className="max-w-screen-2xl mx-auto w-full pb-10 mb-24 ">
      <Card className="border-none drop-shadow-sm">
        <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between">
          <CardTitle className="text-xl line-clamp-1">Transactions Hisotry</CardTitle>
