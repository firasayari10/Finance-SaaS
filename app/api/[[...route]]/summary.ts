...
.get(
  ...
  async (c) => {
    ...
    const incomeChange = caluclatePercentageChange(currentPeriod.income , lastPeriod.income);
    const expensesChange = caluclatePercentageChange(currentPeriod.expense , lastPeriod.expense);
    const remianingChange= caluclatePercentageChange(currentPeriod.remaining , lastPeriod.remaining);
    ...
    //return c.json({ currentPeriod, lastPeriod , incomeChange , expensesChange , remianingChange});
